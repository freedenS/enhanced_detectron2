...
# MOGAI
_C.INPUT.COLOR_TRANSFORM = CN({"ENABLED": False})
# brightness
...
# Options: ReLU, SiLU, Hardswish,Swish,Mish,FReLU
_C.MODEL.FPN.ACTIVATION = "ReLU"

# Types for fusing the FPN top-down and lateral features. Can be either "sum" or "avg"
_C.MODEL.FPN.FUSE_TYPE = "sum"

# add path from bottom to top
_C.MODEL.FPN.BOTTOM_TO_TOP = False
...
# Options: ReLU, SiLU, Hardswish,Swish,Mish,FReLU
_C.MODEL.ROI_MASK_HEAD.ACTIVATION = "ReLU"
...
# Options: ReLU, SiLU, Hardswish,Swish,Mish,FReLU
_C.MODEL.ROI_KEYPOINT_HEAD.ACTIVATION = "ReLU"
# Type of pooling operation applied to the incoming feature map for each RoI
...
# Options: ReLU, SiLU, Hardswish,Swish,Mish,FReLU
_C.MODEL.SEM_SEG_HEAD.ACTIVATION = "ReLU"
...
# Options: ReLU, SiLU, Hardswish,Swish,Mish,FReLU
_C.MODEL.RETINANET.ACTIVATION = "ReLU"
